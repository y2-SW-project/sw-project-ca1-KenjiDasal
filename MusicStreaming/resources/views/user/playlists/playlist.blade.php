...
@section('content')
    <div class="main">
        ...
        <div class="top_section">
            ...
            <a href="{{ route('user.playlists.create') }}" class="btn btn-primary">Add</a>
        </div>
        <div class="tracks ">
            @if (count($playlists)=== 0)
            <p  class="text-center font-weight-bold text-light">There are no Songs.</p>
            @else
                ...
                <tbody>
                    @foreach ($playlists as $playlist)
                        <tr data-id="$playlist->id">
                            <a href="{{ route('user.playlists.details', $playlist->id) }}">
                                <div class="song mb-3">
                                    <div class="img">
                                        <img src="{{ asset('images/' . $playlist->img) }}" alt="">
                                    </div>
                                    <div class="more">
                                        <audio src="{{ asset('music/' . $playlist->path) }}"></audio>
                                        <div class="song_info">
                                        ...
                                        <div class="flex">
                                            <div class="d-flex align-items-center mr-2">
                                                <a href="{{ route('user.playlists.edit', $playlist->id) }}"
                                                    class="btn btn-primary mx-4">Edit</a>
                                            ...
                                            <div>
                                                <button id="play_btn"><i class="fa fa-angle-right"
