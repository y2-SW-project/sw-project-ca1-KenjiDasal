...
@section('content')
    <div class="main">
        ...
        <div class="top_section">
            <h5><i class="fa fa-headphones" aria-hidden="true"></i>&nbsp;&nbsp;Song</h5>
            <a href="{{ route('admin.songs.create') }}" class="btn btn-primary">Add</a>
        </div>
        <div class="tracks ">
            @if (count($songs)=== 0)
                    ...
                    @foreach ($songs as $song)
                        <tr data-id="$song->id">
                            <a href="{{ route('admin.songs.show', $song->id) }}">
                                <div class="song mb-3">
                                    <div class="img">
                                        <img src="{{ asset('images/' . $song->img) }}" alt="">
                                    </div>
                                    <div class="more">
                                        <audio src="{{ asset('music/' . $song->path) }}"></audio>
                                        <div class="song_info">
